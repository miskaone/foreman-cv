...
- **Slug decision:** push as `flowevolve/foreman` (namespaced, clean), `mlydick/foreman-cv` (disambiguated), or `mlydick/foreman` (risk of search collision with the Rails Procfile tool)? Decide before first push.
